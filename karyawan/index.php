...
$tanggalpensiun_normal2 = date_format($tanggalpensiun_normal1, 'd-M-Y');
    ...
    if ($kategori == "M1") $keterangan = "Laki-laki menikah dan memiliki beberapa anak"; else
    if ($kategori == "M2") $keterangan = "Laki-laki menikah belum memiliki anak";else
    if ($kategori == "M3") $keterangan = "Lajang/Duda dan memiliki beberapa anak";else
    if ($kategori == "M4") $keterangan = "Laki-laki Lajang";else
    if ($kategori == "F1") $keterangan = "Perempuan menikah dan memiliki beberapa anak";else
    if ($kategori == "F2") $keterangan = "Perempuan menikah belum memiliki anak";else
    if ($kategori == "F3") $keterangan = "Lajang/Janda dan memiliki beberapa anak";else 
...
<div id="Alternatif 1" class="w3-container city">
  ...
  <div class="company_details">
    <h4>Manfaat Bulanan <span>Nilai Sekarang x 2.5% x PHDP x Masa Kerja | <?php
      ...
      <p class="cmpny1"> <?php echo rupiah($manfaatbulantemp);?></p>
  </div>

  <div class="company_details">
    <h4>Manfaat Sekaligus<span> 0 rupiah | Mengambil 100% Manfaat Bulan</span></h4>
...
?></span></h4>
        <p class="cmpny1"><?php echo rupiah($uanghak)."</div>";} 
    ...
    if (isset($total)){ ?>
     <div class="company_details">
          ...
          <h4 style="text-align: right;font-size: 15px;padding-right: 2.7em;">
                 <?php echo " plus   " . rupiah($manfaatbulantemp);?> tiap bulan </h4>
        </p>
      </div>
...
<?php if(isset($manfaat_pasti)&&$manfaat_pasti){
        if($manfaatbulantemp<1500000){
          $manfaatbulan=$manfaatbulantemp;
          $manfaatsekaligus=0;}
        else {
          $manfaatbulan=0.8*$manfaatbulantemp;
          $manfaatsekaligustemp=$nsekaligus*$manfaatbulantemp;
          $manfaatsekaligus=0.2*$manfaatsekaligustemp;} ?>
...
<div class="company_details">
 ...
 <?php if(isset($pesangon)&&isset($nilaiupmk)){?>
    ...
    else{ $uanghak=0; echo "<h4>Uang Penggantian Hak</h4><p class='cmpny1'>Konsultasikan Penghitungan bersama Divisi HCS";?>
  </div>
...
?>
  ...
  <div class="company_details">
      <h4 style="font-size: 1.2em">Total Tunjangan Sekaligus <span>(plus tunjangan bulanan)</span></h4>
         ...
         <h2 style="text-align: right;padding-right: 1.3em;"><?php echo rupiah($total);?></h2>
         <h4 style="text-align: right;font-size: 15px;padding-right: 2.7em;">
  <?php echo " plus   " . rupiah($manfaatbulantemp);?> tiap bulan </h4></p>
  </div>
    <button class="btn btn-primary btn-lg pull-right" style="margin-right: 2em; margin-top: 1em;padding-left: 2em; padding-right: 2em;" onClick="window.print();">Print</button> 
</div>
