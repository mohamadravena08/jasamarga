...
<html lang="en">
  <head>
    ...
    <title>Tabel Nilai Sekarang</title>
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Nilai Sekarang <small>tabel Master</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Tabel ini berisi Nilai Sekarang.
                    </p>
                      ...
                      <tbody>
                        <?php
                            ...
                            while($row = $res->fetch_assoc()){
                              ...
                              <tr>
                                <td>'.$no.'</td>
                                <td>'.$row['usia_bayar'].'</td>
                                <td>'.$row['nilai_sekarang'].'</td>
                              </tr>
                              ';
                              $no++;
                            }
