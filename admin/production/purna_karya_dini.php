          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Tabel Purna Karya <small>tabel Master</small></h2>
                  ...
                  <div class="x_content">
                    <p class="text-muted font-13 m-b-30">
                      Tabel Faktor Hitung Tunjangan Purna Karya usia >30 tahun sampai dengan 45 tahun
                    </p>
                    <table id="dataTables" class="table table-striped table-bordered">
                      ...
                      <tbody>
                        <?php
                            ...
                            $no = 1;
                            $res = mysqli_query($DBcon,"select * from purna_karya_dini");
